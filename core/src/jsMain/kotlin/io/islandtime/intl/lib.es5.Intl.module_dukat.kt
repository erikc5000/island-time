...
external interface DateTimeFormat {
    ...
    fun format(): String
    fun formatToParts(date: Date = definedExternally): Array<DateTimeFormatPart>
    fun formatToParts(date: Number = definedExternally): Array<DateTimeFormatPart>
    fun formatToParts(): Array<DateTimeFormatPart>?
    companion object {
        @nativeInvoke
