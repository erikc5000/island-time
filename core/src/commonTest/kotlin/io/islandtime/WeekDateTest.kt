...
class WeekDateTest : AbstractIslandTimeTest() {
    ...
    @Test
    fun `Date_fromWeekDate with settings throws an exception when year is out of range`() {
    ...
    @Test
    fun `Date_fromWeekDate with settings throws an exception when week is out of range`() {
    ...
    @Test
    fun `Date_fromWeekDate with settings throws an exception when day is out of range`() {
